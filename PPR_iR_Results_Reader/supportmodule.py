...
def read_results(number,racesessionnumber):
    ...
    with open("results.json") as file: #Opening file
        ...
        for y in range(totaliterations):
            ...
            header = ["Position","Position in class","Name","Car Number","Car","Interval","Fastest Lap","Average Lap","Laps Completed","Points"] #Header above all rows.
            ...
            for i in range(number): #Looping for each driver to read their data.
                ...
                temparray.append(position);temparray.append(name);temparray.append(carnumber);temparray.append(carname);temparray.append(intervalresult);temparray.append(bestlap);temparray.append(averagelap);temparray.append(lapscomplete);temparray.append(points);
                if classname == "Pro":
